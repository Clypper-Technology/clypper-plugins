...
class Rrb2b_Functions
{
    ...
    public function rrb2b_get_roles(): void
    {
        ...
        foreach ($roles as $key => $role) {
            ...
            <tr>
                ...
                <td>
                    <button onclick="rrb2b_show_hidden('ul_<?php echo esc_js($key); ?>');" class="rrb2b-expand-list"><i
                                class="fas fa-list-ul"></i></button>
                    <ul style="margin-top: 2px;margin-bottom:0px;" class="rrb2b-collapsible"
                        id="ul_<?php echo esc_js($key); ?>">
                        <?php
                ...
                <td style="text-align: center;">
                    ...
                    if (in_array($key, $cap_roles, true)) {
                        ...
                        <input type="checkbox" id="<?php echo esc_attr($key); ?>"
                               onclick="rrb2b_delete_role('<?php echo esc_js($key); ?>', '<?php echo esc_js($role['name']); ?>');">
                        <?php
                    }
                    ?>
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php if (!$rule->is_guest() && !$role_obj) : ?>
                        <p style="color:red;">
                            <strong><?php echo esc_html__('Warning: This role no longer exists on the site.', 'woo-roles-rules-b2b'); ?></strong>
                        </p>
                    <?php endif; ?>
                    ...
                    <a href="<?php echo esc_attr(admin_url('users.php?role=' . $rule->post_name)); ?>" target="_new">
                        ...
                        <span style="font-size:.8rem;"><i
                                    class="fas fa-users"></i> <?php esc_html_e('Users:', 'woo-roles-rules-b2b'); ?> <?php esc_attr_e($user_count); ?></span>
                    ...
                    <div class="cas-white-bg-border">
                        <div style="margin-top: 5px;margin-bottom:10px;">
                            <select name="reduce_regular_type" class="rrb2b-select"
                                ...
                                <option value=""
                                        selected="selected"><?php esc_html_e('Select', 'woo-roles-rules-b2b'); ?></option>
                        ...
                        <p>
                            <label for="reduce_regular_type"><?php esc_html_e('General rule for all products', 'woo-roles-rules-b2b'); ?>
                                <i title="<?php esc_html_e('Add value below (general discount). Tip: Use Product Rules tab for better customization.', 'woo-roles-rules-b2b'); ?>"
                            ...
                            <input type="number" oninput="formChanged('<?php echo esc_js($rule->id); ?>');"
                                   ...
                                   placeholder="<?php esc_html_e('e.g. 10', 'woo-roles-rules-b2b'); ?>">
                        </p>
                        <p>
                            <label for="reduce_categories"><?php esc_html_e('General rule for selected categories', 'woo-roles-rules-b2b'); ?>
                                <i title="<?php esc_html_e('Add value below (general discount). Tip: Use Category Rules tab for better customization.', 'woo-roles-rules-b2b'); ?>"
                                   class="fa-solid fa-circle-info"></i></label><br/>
                            <input oninput="formChanged('<?php echo esc_js($rule->id); ?>');" type="number"
                                   ...
                                   placeholder="<?php esc_html_e('e.g. 20', 'woo-roles-rules-b2b'); ?>">
                        </p>
                        ...
                        <div style="margin-top:10px;margin-bottom:10px;">
                            <input type="checkbox" id="chk-all-cat_<?php echo esc_js($rule->id); ?>"
                                   onclick="genCatCheck(<?php echo esc_js($rule->id); ?>);"><?php esc_html_e('Check / uncheck all categories', 'woo-roles-rules-b2b'); ?>
                            <br/>
                        </div>
                    </div>
                        ...
                        <p class="submit_rule">
                            <span id="msg_<?php echo esc_js($rule->id); ?>"
                                  style="display:none;color:red;padding-bottom:8px;"><i
                                        class="fas fa-info-circle"></i> <?php esc_attr_e('Changes in rule, please save!', 'woo-roles-rules-b2b'); ?></span>
                            <button class="button button-primary" type="submit"
                                    id="btn_<?php echo esc_js($rule->id); ?>"><i
                                        class="fas fa-save"></i> <?php esc_attr_e('Save Rules', 'woo-roles-rules-b2b'); ?>
                            </button>
                            <button class="button" onclick="deleteRule(this);" style="margin-bottom: 5px;"><i
                                        class="fas fa-trash-alt"></i> <?php esc_attr_e('Delete rule', 'woo-roles-rules-b2b'); ?>
                            </button>
                        </p>
                    </div>
                    </form>
        ...
        foreach ($rules as $rule) {
            ...
            <tr>
                <td>
                    ...
                    <?php else : ?>
                        <h3 class="rrb2b-circle-gray-h3"
                            title="<?php echo esc_attr(!$rule->rule_active ? __('Make active in General Rules (tab)', 'woo-roles-rules-b2b') : ''); ?>">
                        ...
                        <div style="text-align: left;margin-top:10px;">
                            <a class="button" href="#"
                               onclick="checkCategories('<?php echo esc_js($rule->id); ?>', this );"><i
                                        class="fas fa-check-circle"></i> <?php esc_attr_e('Check all', 'woo-roles-rules-b2b'); ?>
                            </a>
                            <a id="categories_add_<?php echo esc_js($rule->id); ?>" class="button"
                               href="<?php esc_attr_e($url); ?>&eid=<?php echo esc_js($rule->id); ?>"><i
                                        class="fas fa-plus-circle"></i> <?php esc_attr_e('Add categories', 'woo-roles-rules-b2b'); ?>
                            </a>
                        </div>
                    </div>
                ...
                <td>
                    <div>
                        <button class="button" onclick="rrb2b_toggle_div_cat('<?php echo esc_js($rule->id); ?>');"><i
                                    class="fas fa-edit"></i> <?php esc_attr_e('Edit', 'woo-roles-rules-b2b'); ?>
                        </button>
                    </div>
                            ...
                            <caption style="margin-bottom:10px;width:100%;text-align:right;">
                                <div style="display: inline-block;text-align:right;">
                                    <input type="search" onmouseover="this.focus();"
                                           ...
                                           placeholder="<?php esc_html_e('Search...', 'woo-roles-rules-b2b'); ?>">
                                </div>
                            </caption>
                            <thead>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <button class="button"
                                        ...
                                        <i class="fa-regular fa-eye"></i> <?php esc_attr_e('Find Duplicates', 'woo-roles-rules-b2b'); ?>
                                    </button>
                                </td>
                                <td colspan="7">
                                    <div style="float:right;">
                                        <button type="button"
                                            ...
                                            <i class="fas fa-save"></i> <?php esc_attr_e('Save Changes', 'woo-roles-rules-b2b'); ?>
                                        </button>
                                    </div>
                                </td>
                            </tr>
                    ...
                    <div id="prod1_<?php echo esc_js($rule->id); ?>"
                        ...
                        <div style="margin-top: 10px;">
                            <input type="text" style="width: 75%;" id="product_search_<?php echo esc_js($rule->id); ?>"
                                   ...
                                   placeholder="<?php esc_attr_e('Search product', 'woo-roles-rules-b2b'); ?>">
                            <a id="product_add_<?php echo esc_js($rule->id); ?>" class="button"
                               href="<?php esc_attr_e($url); ?>"><?php esc_attr_e('Add', 'woo-roles-rules-b2b'); ?></a>
                        </div>
                        <div style="margin-top: 10px;">
                                    ...
                                    <div style="float:right;">
                                        <button type="button" id="updateButton-<?php echo esc_js($rule->id); ?>"
                                                ...
                                                onclick="updateProducts('<?php echo esc_js($rule->id); ?>', event);"><i
                                                    class="fas fa-save"></i> <?php esc_attr_e('Save changes', 'woo-roles-rules-b2b'); ?>
                                        </button>
                                    </div>
                                </td>
                            </tr>
    ...
    public function rrb2b_get_categories_select($id): void
    {
        ...
        <form name="rrb2b-select-category" id="rrb2b-select-category-<?php echo esc_attr($id); ?>" onchange="">
            ...
            <div style="margin-top:10px;">
                <input type="checkbox"
                       name="variations"><?php echo esc_attr_e('Include variations', 'woo-roles-rules-b2b'); ?>
                <button type="button" class="button" onclick="findCategoryProducts('<?php echo esc_attr($id); ?>');"
                        style="margin-top:10px;"><?php echo esc_attr_e('Get products', 'woo-roles-rules-b2b'); ?></button>
            </div>
